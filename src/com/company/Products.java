...
public class Products {
    ...
    public Products(String shop, String address, String vendorCode, String nameOfProduct, int amountOfProducts, float price) {
            this.setShop(shop);
    ...
    public void setTotal(float total) {
        ...
        this.total = this.amountOfProducts * this.price;
    }
